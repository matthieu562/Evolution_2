...
class Menu_Manager:
    ...
    def create_main_menu(self):
        main_menu = pygame_menu.Menu('Evolution 2 !', WINDOW_WIDTH, WINDOW_HEIGHT, theme=pygame_menu.themes.THEME_DARK)
        main_menu.add.button('Play', self.start_game)
        main_menu.add.button('Quit', pygame_menu.events.EXIT)
        return main_menu

    def create_pause_menu(self):
        pause_menu = pygame_menu.Menu('Pause', WINDOW_WIDTH, WINDOW_HEIGHT, theme=pygame_menu.themes.THEME_DARK)
